...
import Problem1.hardwareCombinationPackage.AtMegaCombinationFactory;
...
public class SilverPackageBuilder implements PackageBuilder{

    private FinalProduct finalProduct;

    public SilverPackageBuilder(){
        finalProduct = new FinalProduct();
    }

    public void buildHardware(){
        HardwareCombination hardwareCombination = new HardwareCombination(new AtMegaCombinationFactory());
